...
import org.apache.spark.sql.functions.{avg, col, current_timestamp, from_json, lit, max, min, unix_timestamp}
...
object SparkApp extends App {
  ...
  val topicAgg = sys.env.getOrElse("topic_server_agg", "topicAgg")
